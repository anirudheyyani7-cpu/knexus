...
// Abstract, brand-palette-only "art" — stands in for a photo without leaving
// the KPMG/knexus color system. Cycled by card index for a bit of variety.
const CARD_ART = [
    ...
    <StaggerItem index={index} className="h-full">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h3 className="mt-4 text-xl font-bold text-white leading-snug">{solution.title}</h3>
        ...
        <div
          className={cn(
            "relative z-10 flex h-10 w-10 items-center justify-center self-end rounded-full bg-brand-blue text-white",
